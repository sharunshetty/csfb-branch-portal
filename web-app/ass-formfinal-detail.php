                                                                    ...
                                                                    <td>
                                                                        <?php
                                                                            if(isset($item_data1['ASSREQ_PRODUCT_CODE']) && $item_data1['ASSREQ_PRODUCT_CODE'] != "") {
                                                                                $prdnm = $main_app->sql_fetchcolumn("SELECT PRODUCT_DESC FROM SBREQ_PRODUCT_CODE WHERE PRODUCT_CODE = '".$item_data1['ASSREQ_PRODUCT_CODE']."'");
                                                                    ...
                                                                    <td>
                                                                        <?php
                                                                            if(isset($item_data1['ASSREQ_FATHERSNAME']) && $item_data1['ASSREQ_FATHERSNAME'] != "") {
                                                                                echo  $main_app->strsafe_output($item_data1['ASSREQ_FATHERSNAME']);
                                                                            } 
                                                                        ?>    
                                                                    </td>
                                                                </tr>
