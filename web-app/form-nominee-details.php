                    ...
                    <form name="form-nominee-details" id="form-nominee-details" method="post" action="javascript:void(0);" class="form-material">
                      ...
                      <div class="row mt-3 mb-4 mx-auto d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="col-md-5 col-lg-4 form-group my-2">
                          ...
                          <div class="col-md-12">
                            <input type="text" name="NOMINEE_NAME" id="NOMINEE_NAME" class="form-control border-input reset-form" autocomplete="off">
                          </div>
                        </div>
                        ...
                        <div class="col-md-5 col-lg-4 form-group my-2">
                          ...
                          <div class="col-md-12">
                            <textarea name="NOMINEE_ADDRESS" id="NOMINEE_ADDRESS" maxlength="250" rows="4" class="form-control border-input js-maxCheck js-noEnter no-resize" autocomplete="none"></textarea>
                          </div>
                        </div>
                        ...
                        <div class="row" id="guarddetails" style="display: none;">
                          ...
                          <div class="col-md-6 form-group my-2">
                            ...
                            <div class="col-md-12">
                              <input type="text" name="NOMINEE_GUARDIAN" id="NOMINEE_GUARDIAN" class="form-control border-input reset-form" autocomplete="off">
                            </div>
                          </div>
