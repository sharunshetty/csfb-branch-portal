                ...
                <form name="form-customer-details" id="form-customer-details" method="post" action="javascript:void(0);" class="form-material">
                  ...
                  <!--  <?php 
                    ...
                    <div class="col-md-4 form-group">
                      ...
                      <div class="col-md-12">
                        <input type="text" name="CUST_FULL_NAME" id="CUST_FULL_NAME" maxlength="" class="form-control border-input reset-form js-toUpper" autocomplete="none" value= "<?php echo $main_app->strsafe_input($aadhaar_name); ?>" readonly>
                       </div>
                    </div>
                    ...
                    <div class="col-md-4 form-group">
                      ...
                      <div class="col-md-12">
                        ...
                        <input type="text" name="FATHERS_NAME" id="FATHERS_NAME"  value="<?php echo $fathername; ?>" class="form-control border-input reset-form" autocomplete='none'>
                    ...
                    <div class="col-md-4 form-group">
                      ...
                      <div class="col-md-12">
                      <input type="text" name="MOTHERS_NAME" id="MOTHERS_NAME" maxlength="" class="form-control border-input reset-form" autocomplete="off">
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 form-group">
                      ...
                      <div class="col-md-12">
                        <?php
                          ...
                          echo '<textarea name="CUST_ADDRESS" id="CUST_ADDRESS" class="form-control border-input" rows="5" autocomplete="none">'.$combined_address.'</textarea>';
                    ...
                    <div class="col-md-4 form-group">
                      <label class="col-md-12 label_head">Weaker Section Code <mand>*</mand></label>
                      <div class="col-md-12">
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      <?php
        ...
        if(isset($item_data1['ASSREQ_MARITAL_STATUS']) && $item_data1['ASSREQ_MARITAL_STATUS'] == 2 && isset($kycDetails['husbandName']) =="" ) { 
