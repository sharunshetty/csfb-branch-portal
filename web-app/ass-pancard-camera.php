...
$page_title = "Pan Card Photo Verification";
$page_link = "";
                    ...
                    <div class="card card-outline card-brand">
                        <div class="card-body min-high2">
                            <div class="row justify-content-center">
                                <form id="app-service-pan-cam" name="app-service-pan-cam" class="form-material">
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12 text-center h5">Take your Pan Card photo</div>
                                        </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-9 col-lg-9">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-12 justify-content-center text-center ml-2">
