                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-sm">
                                    <tbody>
                                        ...
                                        echo isset($item_data["ASSREQ_CUST_FNAME"]) ? $item_data["ASSREQ_CUST_FNAME"] : "-NA-";
                                        echo '</td></tr>';
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    <tbody>
                                        ...
                                        if (isset($item_data2['ASSREQ_INUSURANCE_INFO']) && $item_data2['ASSREQ_INUSURANCE_INFO']) {
                                            if ($item_data2['ASSREQ_INUSURANCE_INFO'] == "1") {
                                                $insinfo = "Insurance Policy Available";
                                            } else if ($item_data2['ASSREQ_INUSURANCE_INFO'] == "N") {
                                        ...
                                        if (isset($item_data2['ASSREQ_DBTCHECK']) && $item_data2['ASSREQ_DBTCHECK']) {
                                            if ($item_data2['ASSREQ_DBTCHECK'] == "1") {
                                                $benef = "Yes";
                                            } else if ($item_data2['ASSREQ_DBTCHECK'] == "N") {
                                                $benef = "No";
                                            }
                                        }
